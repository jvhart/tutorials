...
pyplot.figure()
pyplot.plot(train_loss_ls)
pyplot.plot(test_loss_ls)
pyplot.legend(['Training Loss', 'Test Loss'])
pyplot.show()



torch.save(model.state_dict(), "relu_stack_model.pth")
print("Saved PyTorch Model State to relu_stack_model.pth")

model = NeuralNetwork().to(device)
model.load_state_dict(torch.load("relu_stack_model.pth"))
